...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'b1211004-466d-11f0-b8c8-7c74d0b92cb2:1-383';
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Tabel learning logs - log belajar harian (Anggota 2)';
...
INSERT INTO `learning_logs` VALUES (7,'3','2025-12-12',NULL,'2025-12-11 21:30:22','[5, 4]');
...
INSERT INTO `sessions` VALUES ('DQEL5uzDkwuydjbGngftQ5YiN_5IEks2',1765487286,'{\"cookie\":{\"originalMaxAge\":86400000,\"expires\":\"2025-12-11T20:50:07.055Z\",\"secure\":false,\"httpOnly\":true,\"path\":\"/\"},\"userId\":2}'),('jfN7ONihrTJuYwPe8jYEyCRNd5AtM63p',1765488216,'{\"cookie\":{\"originalMaxAge\":86400000,\"expires\":\"2025-12-11T21:19:54.909Z\",\"secure\":false,\"httpOnly\":true,\"path\":\"/\"},\"userId\":3}'),('rGPyNOAlQ5H_o3rtSQICe0X7nRlpQ0cX',1765462333,'{\"cookie\":{\"originalMaxAge\":86400000,\"expires\":\"2025-12-11T13:37:08.360Z\",\"secure\":false,\"httpOnly\":true,\"path\":\"/\"},\"userId\":2}');
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Tabel tasks untuk tugas per user';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_tasks` VALUES (2,'2','mengajar','teras','completed','medium','2025-12-20','2025-12-10 20:45:50','2025-12-10 21:00:57'),(3,'2','mengerjakan abc','cec','completed','low','2025-12-11','2025-12-10 21:02:05','2025-12-10 21:02:47'),(4,'3','mengajar','matematika','completed','medium','2025-12-12','2025-12-10 21:22:13','2025-12-11 21:30:23'),(5,'3','halo','halo','completed','medium','2025-12-13','2025-12-11 21:24:25','2025-12-11 21:30:22');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Tabel users untuk authentication (Anggota 4)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'ibnu','ibnu@gmail.com','$2b$10$xrs/9h6wLlP.xPH4A36KRuYgO9.N4tj/iN85epvemE2Qz1/t05ECy','2025-11-19 04:24:00'),(2,'christopher083','christopher078@gmail.com','$2b$10$u6Bn9EWX.rQP7cKC.HF67uC5FtvdAtSzYT1K9niXMEykX21wvjeea','2025-12-10 13:22:05'),(3,'halo','halo@gmail.com','$2b$10$zuX5PM6q4A1aROBAHnIxeuHERDtHbniX2KNsENOCjklT55jzgGpXC','2025-12-10 21:19:54');
...
CREATE TABLE `weekly_targets` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Tabel weekly targets - jadwal belajar mingguan (Anggota 1)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-12-11  4:32:06
